...
%q = [13.7, -29, 23.1, 65, -22.3] * pi/180 %%%%%%%%%%%%%%   para 1 sola solución
q = [0, 0, 0, 2, 0] * pi/180 %%%%%%%%%%%%%%% para 2 soluciones (codo arriba y codo abajo)

% Calcular la matriz de transformación homogénea para las articulaciones dadas
disp('Matriz de transformación homogénea T:');
T = R.fkine(q);

q0 = [0,0,0,0,0];
%única solución (en caso de true): la más cercana al "q0" pasado; o debe devolver todas las soluciones halladas (caso de false). 
qq = cin_inv(R,T,q0,false); %true o false
disp('Solución/es posibles:')
disp('q1      q2          q3        q4        q5')
disp(qq*180/pi);
...
T =  invHomog(R.base.double) * Tdato.double * invHomog(R.tool.double);
